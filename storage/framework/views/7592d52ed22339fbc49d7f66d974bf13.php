...
<h2 style="font-family:'Playfair Display',serif;color:var(--prussia-700);font-weight:800;margin-bottom:1.5rem;">
    <i class="bi bi-<?php echo e($project ? 'pencil' : 'plus-circle'); ?> me-2" style="color:var(--gold-500);"></i>
    <?php echo e($project ? 'Edit Proyek' : 'Tambah Proyek Baru'); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <small class="text-danger" style="font-size:.78rem;"><?php echo e($message); ?></small> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                ...
                <textarea id="description" name="description" class="admin-input" rows="4"
                          placeholder="Ringkasan proyek singkat yang akan ditampilkan di landing page…"><?php echo e(old('description', $project->description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" id="order" name="order" class="admin-input"
                       value="<?php echo e(old('order', $project->order ?? ($projects_total ?? 1))); ?>"
                       min="0" max="999">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="hours_tag" name="hours_tag" class="admin-input"
                       value="<?php echo e(old('hours_tag', $project->hours_tag ?? '')); ?>"
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="price_tag" name="price_tag" class="admin-input"
                       value="<?php echo e(old('price_tag', $project->price_tag ?? '')); ?>"
            ...
            <div class="col-12">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                              value="1" <?php echo e(old('is_active', $project->is_active ?? true) ? 'checked' : ''); ?>
            ...
            <div class="col-12 mt-4">
                <button type="submit" class="btn-gold me-2">
                    <i class="bi bi-check-lg me-1"></i><?php echo e($project ? 'Simpan Perubahan' : 'Tambah Proyek'); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Portfolio\lp-laravel\resources\views/admin/projects/form.blade.php ENDPATH**/ ?>