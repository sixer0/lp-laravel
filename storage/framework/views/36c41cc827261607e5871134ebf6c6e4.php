...
<head>
    ...
    <title><?php echo e($page_title ?? 'CMS' . ' — Sixer0'); ?></title>
...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/admin" class="nav-item <?php echo e((request()->path() === 'admin' || request()->path() === 'admin/') ? 'active' : ''); ?>">
            <i class="bi bi-speedometer2 me-2"></i>Dashboard
        </a>

        <div class="sidebar-section">Konten</div>
        <a href="/admin/projects" class="nav-item <?php echo e(request()->is('admin/projects*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <div class="username"><i class="bi bi-person-circle me-1"></i><?php echo e(session('admin_name','Admin')); ?></div>
...
<div class="admin-main">
    ...
    <header class="admin-topbar">
        <div style="display:flex;align-items:center;gap:.75rem;">
            ...
            <div class="topbar-title"><?php echo e($page_title ?? 'Dashboard'); ?></div>
        </div>
    ...
    <main class="admin-content">
        <?php if(session('admin_msg')): ?>
            <div class="alert-admin alert-admin-success">
                <i class="bi bi-check-circle-fill me-2"></i><?php echo e(session('admin_msg')); ?>
...
<?php /**PATH /home/sixq7133/public_html/landing.sixer0-bk.my.id/resources/views/admin/layout.blade.php ENDPATH**/ ?>